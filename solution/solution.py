...
def call_openai(
    ...
    # NVIDIA NIM yêu cầu top_p cố định ở 0.95 cho các model trong lab.
    request_top_p = 0.95 if "nvidia" in os.getenv("OPENAI_BASE_URL", "").lower() else top_p
